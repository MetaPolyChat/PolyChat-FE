...
var colorCurves_1 = require("@babylonjs/core/Materials/colorCurves");
var texture_1 = require("@babylonjs/core/Materials/Textures/texture");
var decorators_1 = require("@babylonjs/core/Misc/decorators");
var colorGradingTexture_1 = require("@babylonjs/core/Materials/Textures/colorGradingTexture");
...
var ssrRenderingPipeline_1 = require("@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/ssrRenderingPipeline");
 ...
 */
function appendScene(toScene, rootUrl, sceneFilename, onProgress) {
    return __awaiter(this, void 0, void 0, function () {
        var filesCount, intervalId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sceneLoader_1.SceneLoader.AppendAsync(rootUrl, sceneFilename, toScene, function (p) { return onProgress === null || onProgress === void 0 ? void 0 : onProgress(p, "sceneLoading"); }, ".babylon")];
                case 1:
                    _a.sent();
                    toScene.meshes.forEach(function (m) {
                        if (m instanceof mesh_1.Mesh) {
                            m._checkDelayState();
                        }
                    });
                    filesCount = toScene._pendingData.length;
                    intervalId = onProgress ? setInterval(function () {
                        var currentFilesCount = toScene._pendingData.length;
                        var loaded = filesCount - currentFilesCount;
...
function requireScriptForNodes(scene, scriptsMap, nodes) {
    ...
    // Initialize nodes
    for (var _i = 0, _o = nodes; _i < _o.length; _i++) {
        var n = _o[_i];
            ...
            if (exports_1.IsGraph) {
                ...
                switch (className) {
                    ...
                    case "SpotLight":
                        ...
                        break;
                    case "InstancedMesh":
                        clone = Reflect.construct(prototype.constructor, [null, n.sourceMesh]);
                        break;
                    case "TouchCamera":
    ...
    var _loop_2 = function (i) {
        ...
        for (var key in properties) {
            ...
            switch (p.type) {
                ...
                case "Vector4":
                    ...
                    break;
                case "Quaternion":
                    n[key] = new math_vector_1.Quaternion(p.value.x, p.value.y, p.value.z, p.value.w);
                    break;
                case "Color3":
                ...
                case "Color4":
                    ...
                    break;
                case "Node":
                    n[key] = scene_3.getNodeById(p.value);
                    break;
                default:
                    n[key] = p.value;
                    break;
        ...
        if (n instanceof node_1.Node) {
            ...
            for (var _q = 0, childrenLinks_1 = childrenLinks; _q < childrenLinks_1.length; _q++) {
                var link = childrenLinks_1[_q];
                _loop_3(link);
            }
        }
        // Check linked nodes from scene.
        var sceneLinks = (_e = e.default._SceneValues) !== null && _e !== void 0 ? _e : [];
        for (var _r = 0, sceneLinks_1 = sceneLinks; _r < sceneLinks_1.length; _r++) {
            var link = sceneLinks_1[_r];
        ...
        for (var _s = 0, particleSystemLinks_1 = particleSystemLinks; _s < particleSystemLinks_1.length; _s++) {
            var link = particleSystemLinks_1[_s];
            _loop_4(link);
        }
        // Check animation groups
        var animationGroupLinks = (_g = e.default._AnimationGroupValues) !== null && _g !== void 0 ? _g : [];
        for (var _t = 0, animationGroupLinks_1 = animationGroupLinks; _t < animationGroupLinks_1.length; _t++) {
            var link = animationGroupLinks_1[_t];
        ...
        for (var _u = 0, soundLinks_1 = soundLinks; _u < soundLinks_1.length; _u++) {
            var link = soundLinks_1[_u];
            _loop_5(link);
        }
        // Materials
        var materialLinks = (_j = e.default._MaterialsValues) !== null && _j !== void 0 ? _j : [];
        for (var _v = 0, materialLinks_1 = materialLinks; _v < materialLinks_1.length; _v++) {
            var link = materialLinks_1[_v];
        ...
        for (var _w = 0, pointerEvents_1 = pointerEvents; _w < pointerEvents_1.length; _w++) {
            var event_1 = pointerEvents_1[_w];
            _loop_6(event_1);
        }
        var resultCallback = function () {
            ...
            var keyboardEvents = (_a = e.default._KeyboardValues) !== null && _a !== void 0 ? _a : [];
            ...
            for (var _i = 0, keyboardEvents_1 = keyboardEvents; _i < keyboardEvents_1.length; _i++) {
                var event_2 = keyboardEvents_1[_i];
                _loop_7(event_2);
            }
            // Check resize events
            var resizeEvents = (_b = e.default._ResizeValues) !== null && _b !== void 0 ? _b : [];
            ...
            for (var _f = 0, resizeEvents_1 = resizeEvents; _f < resizeEvents_1.length; _f++) {
                var event_3 = resizeEvents_1[_f];
                _loop_8(event_3);
            }
            // Retrieve impostors
            if (n instanceof abstractMesh_1.AbstractMesh && !n.physicsImpostor) {
                n.physicsImpostor = (_d = (_c = n._scene.getPhysicsEngine()) === null || _c === void 0 ? void 0 : _c.getImpostorForPhysicsObject(n)) !== null && _d !== void 0 ? _d : null;
            }
            delete n.metadata.script;
            // Tell the script it has is ready
            (_e = n.onInitialized) === null || _e === void 0 ? void 0 : _e.call(n);
        };
        // Check asynchronous components
        var promises = [];
        var guiPath = (_l = e.default._GuiPath) !== null && _l !== void 0 ? _l : (_m = n.metadata) === null || _m === void 0 ? void 0 : _m.guiPath;
        if (guiPath) {
    ...
    for (var _p = 0, initializedNodes_1 = initializedNodes; _p < initializedNodes_1.length; _p++) {
        var i = initializedNodes_1[_p];
        _loop_2(i);
    }
    dummyScene.dispose();
}
...
function runScene(scene, rootUrl) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (rootUrl && exports.projectConfiguration.autoLod.autoApply) {
 ...
 */
exports.ssrRenderingPipelineRef = null;
/**
...
function configurePostProcesses(scene, rootUrl) {
    ...
    if (data.ssr && !exports.ssrRenderingPipelineRef) {
        exports.ssrRenderingPipelineRef = ssrRenderingPipeline_1.SSRRenderingPipeline.Parse(data.ssr.json, scene, rootUrl);
        if (!data.ssr.enabled) {
            scene.postProcessRenderPipelineManager.detachCamerasFromRenderPipeline(exports.ssrRenderingPipelineRef.name, scene.cameras);
        }
    }
    ...
    if (data.default && !exports.defaultRenderingPipelineRef) {
        ...
        exports.defaultRenderingPipelineRef.imageProcessing.toneMappingType = data.default.json.imageProcessing.toneMappingType;
        exports.defaultRenderingPipelineRef.imageProcessing.colorCurvesEnabled = (_c = data.default.json.imageProcessing.colorCurvesEnabled) !== null && _c !== void 0 ? _c : exports.defaultRenderingPipelineRef.imageProcessing.colorCurvesEnabled;
        exports.defaultRenderingPipelineRef.imageProcessing.colorGradingEnabled = (_d = data.default.json.imageProcessing.colorGradingEnabled) !== null && _d !== void 0 ? _d : exports.defaultRenderingPipelineRef.imageProcessing.colorGradingEnabled;
        if (data.default.json.imageProcessing.colorCurves) {
            exports.defaultRenderingPipelineRef.imageProcessing.colorCurves = colorCurves_1.ColorCurves.Parse(data.default.json.imageProcessing.colorCurves);
        }
        if (data.default.json.imageProcessing.colorGradingTexture) {
            ...
            exports.defaultRenderingPipelineRef.imageProcessing.colorGradingTexture = colorGradingTexture_1.ColorGradingTexture.Parse(data.default.json.imageProcessing.colorGradingTexture, scene);
        }
        // Vignette
    ...
    if ((_e = data.motionBlur) === null || _e === void 0 ? void 0 : _e.json) {
 ...
 */
function handleTexturesLods(scene, rootUrl) {
    if (!exports.projectConfiguration.autoLod.enabled) {
        return;
    }
    var uniqueTextures = [];
    scene.textures.forEach(function (t) {
        var internalTexture = t.getInternalTexture();
        if (!internalTexture || t.getClassName() !== "Texture") {
            return;
        }
        var existing = uniqueTextures.find(function (ut) { return ut.getInternalTexture() === internalTexture; });
        if (!existing) {
            uniqueTextures.push(t);
        }
    });
    uniqueTextures.forEach(function (t) {
        var _a, _b;
        if (!((_b = (_a = t.metadata) === null || _a === void 0 ? void 0 : _a.lods) === null || _b === void 0 ? void 0 : _b.length)) {
            return;
        }
        checkTextureLods(scene, t, rootUrl);
    });
}
exports.handleTexturesLods = handleTexturesLods;
function wait(timeMs) {
    return new Promise(function (resolve) { return setTimeout(resolve, timeMs); });
}
function checkTextureLods(scene, t, rootUrl) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var lod, internalTexture, finalUrl, tempTexture;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, wait(1000)];
                case 1:
                    _c.sent();
                    lod = (_b = (_a = t.metadata) === null || _a === void 0 ? void 0 : _a.lods) === null || _b === void 0 ? void 0 : _b.pop();
                    if (!lod) {
                        return [2 /*return*/];
                    }
                    _c.label = 2;
                case 2:
                    if (!!t.isReadyOrNotBlocking()) return [3 /*break*/, 4];
                    return [4 /*yield*/, wait(150)];
                case 3:
                    _c.sent();
                    return [3 /*break*/, 2];
                case 4:
                    internalTexture = t.getInternalTexture();
                    if (!(internalTexture === null || internalTexture === void 0 ? void 0 : internalTexture.url)) {
                        return [2 /*return*/];
                    }
                    finalUrl = "".concat(rootUrl).concat(lod);
                    tempTexture = new texture_1.Texture(finalUrl, scene, {
                        mimeType: t.mimeType,
                        format: t.textureFormat,
                        useSRGBBuffer: t.isRGBD,
                    }, t.invertY, t.samplingMode, undefined);
                    return [4 /*yield*/, new Promise(function (resolve) {
                            tempTexture.onLoadObservable.addOnce(function () {
                                var _a;
                                if (!tempTexture.loadingError) {
                                    var tempUrl = (_a = tempTexture.getInternalTexture()) === null || _a === void 0 ? void 0 : _a.url;
                                    if (tempUrl) {
                                        t.updateURL(tempUrl);
                                    }
                                }
...
(function overrideTextureParser() {
    ...
    decorators_1.SerializationHelper._TextureParser = function (sourceProperty, scene, rootUrl) {
        ...
        if (sourceProperty.url && texture instanceof texture_1.Texture) {
