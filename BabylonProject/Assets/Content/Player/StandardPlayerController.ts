module PROJECT {
    ...
    */
    export class StandardPlayerController extends BABYLON.Toolkit.ScriptComponent {
        ...
        public avatarSkinTag: string = "Skin";
        ...
        public boomPosition: BABYLON.Vector3 = new BABYLON.Vector3(0, 0, 0);
        ...
        private playerControl: number = 0;
        ...
        /** TODO */
        public setPlayerControl(mode: PROJECT.PlayerInputControl): void {
        ...
        /** TODO */
        public togglePlayerControl(): void {
        ...
        private showAvatarSkins(show: boolean): void {
            if (this.avatarSkins != null) {
                // TODO - Make Skins Visible Or Not TO Camera But Keep Shadows - ???
                this.avatarSkins.forEach((skin: BABYLON.AbstractMesh) => { skin.isVisible = show; });
            }
        }
        ...
        private awakePlayerController(): void {
            ...
            if (this.avatarSkinTag != null && this.avatarSkinTag !== "") {
                this.avatarSkins = this.getChildrenWithTags(this.avatarSkinTag, false) as BABYLON.AbstractMesh[];
            }
            const pcontrol: number = this.getProperty("playerControl", this.playerControl);
            ...
            if (this.showDebugColliders === true) {
                const testPivot: BABYLON.Mesh = BABYLON.MeshBuilder.CreateBox("TestPivot", { width: 0.25, height: 0.25, depth: 0.5 }, this.scene);
                ...
                if (this.playerControl === PROJECT.PlayerInputControl.FirstPersonStrafing) {
                    ...
                    if (this.freeLooking === true) {
                        if (this.inputMagnitude > 0) {
                            ...
                            const strafingTurnRatio: number = (this.playerMovementVelocity.length() / this.moveSpeed);
                            const strafingTurnSpeed: number = BABYLON.Scalar.Lerp(this.highTurnSpeed, this.lowTurnSpeed, strafingTurnRatio);
    ...
    */
    export enum PlayerInputControl {
    ...
    */
    export enum ActionAnimationType {
        Neutral = 0,
        StepUp = 1,
        JumpUp = 2,
        ClimbUp = 3,
