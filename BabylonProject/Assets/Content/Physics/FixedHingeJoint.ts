module PROJECT {
    ...
    */
    export class FixedHingeJoint extends BABYLON.Toolkit.ScriptComponent {
        public bodyA: BABYLON.TransformNode = null;
        public bodyB: BABYLON.TransformNode = null;
        public pivotA: BABYLON.Vector3 = new BABYLON.Vector3(0, 0, -0.5);
        public pivotB: BABYLON.Vector3 = new BABYLON.Vector3(0, 0, 0.5);
        public constraint: BABYLON.HingeConstraint = null;
